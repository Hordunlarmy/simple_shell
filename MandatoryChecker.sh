...
######### case 19
command1=$(echo "setenv MY_VAR my_value" | ./hsh 2>&1)
command2=$(echo "export MY_VAR=my_value" | sh 2>&1)
echo "$command1" > 1a2b3c4d5e6f7g8h9i
echo "$command2" > 1a2b3c4d5e6f7g8h9b
run_check "setenv MY_VAR my_value"

######### case 20
command1=$(echo "unsetenv MY_VAR" | ./hsh 2>&1)
command2=$(echo "unset MY_VAR" | sh 2>&1)
echo "$command1" > 1a2b3c4d5e6f7g8h9i
echo "$command2" > 1a2b3c4d5e6f7g8h9b
run_check "unsetenv MY_VAR"

######### case 21
command1=$(echo "cd" | ./hsh 2>&1)
command2=$(echo "cd" | sh 2>&1)
echo "$command1" > 1a2b3c4d5e6f7g8h9i
echo "$command2" > 1a2b3c4d5e6f7g8h9b
run_check "cd"
